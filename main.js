    ...
    try {
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.unban'):
                ...
                break;
            case userMessage === '.help' || userMessage === '.menu' || userMessage === '.bot' || userMessage === '.xd':
            ...
            case userMessage.startsWith('.mode'):
                ...
                try {
                    ...
                    await sock.sendMessage(chatId, { text: `xd is now in *${action}* mode`, ...channelInfo });
                } catch (error) {
                    console.error('Error updating access mode:', error);
                    await sock.sendMessage(chatId, { text: 'Failed to update xd access mode', ...channelInfo });
                }
                break;
            ...
            case userMessage.startsWith('.weather'):
                ...
                if (city) {
                    ...
                    await sock.sendMessage(chatId, { text: 'Please specify a city, e.g., .weather Mutoko', ...channelInfo }, { quoted: message });
                }
                break;
